  ...
  return (
    <main className="min-h-screen bg-gray-50 px-4 py-20 flex flex-col items-center text-center">
      <div className="flex flex-col items-center space-y-12 mb-16">
        <img src="/logo.svg" alt="OpenAssist Logo" className="h-8 sm:h-10" onError={(e) => e.currentTarget.style.display='none'} />
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-xl relative px-2 sm:px-0">
        <input
          type="text"
          className="w-full px-4 py-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black pr-12 text-sm sm:text-base placeholder:truncate sm:placeholder:text-base placeholder:text-sm"
